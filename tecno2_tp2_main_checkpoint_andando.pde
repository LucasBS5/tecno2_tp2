...
//TO DO LIST
//calibrar  metodo de captura  a bblob punto mas brillante
//ajustar mecanica de angry birds
//achicar tuneles
...
void draw() {
  ...
  if (estado=="inicio") {
    ...
    if (estado!="jugando"  && !inicioCargado && millis() - tiempoInicio >= 3000 && mouseY<height/2) {
      estado="jugando";
    }
  }
